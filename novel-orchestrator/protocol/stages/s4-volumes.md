# stage:s4 — 书庭S4·分卷庭 配套知识包

| 键 | 值 |
|---|---|
| 阶段 | s4：分卷草案 + 卷1蓝图 + style 定稿 + 红线自查（书庭收尾场，court.md §2 S4 行） |
| 进入 | dec_003 暂存在 → `novel.py court open S4 --node book` |
| 退出 | dec_004；书庭定稿包 commit：book/world/style/vol_01 全部 committed（court.md §3 定稿落盘） |
| 下一阶段 | arc（首弧规划）；后续新卷回 vol（卷庭） |
...
| K-ID | 名称 | 何时挑 |
|---|---|---|
| K-CONCEPT-015 | 三种结局模式 | 分卷草案收束设计 |
| K-STRUCT-003 | 23序列法总论 | 全书节拍骨架（操作面在 rhythm/classic24.md） |
| K-STRUCT-004 | 序列0–6详解 | 第一幕/卷1蓝图细化 |
