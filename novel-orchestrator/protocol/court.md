...
开书先讨论阅读体验、开放主题与可持续事件机制；S1–S3 的概念/世界/人物允许往返。S4 前选择关键趣味、关系或兑现场景试写，单独标试写、不入 canon；根据文字效果修订设计。各场既有命令顺序只是文件管理，不要求创作认知单向前进。

卷庭接受原计划本身可能不再成立，附具体正文证据与候选路径。弧规划按模式维度组合，填写因果与读者信息两张视图；不用统一比例来替作品选择。详见 methodology/story-engine.md、methodology/patterns.md。
