...
简报中的 creative_brief 提供本章期望体验、关系来处、编辑预估的读者理解、所用模式与自由度；它不是新增世界事实。与正式事实冲突时报告，不替作者圆谎。方法应附本场适用步骤或小例，而不只下达“写得有潜台词”的指令。

场景可以改变事件、理解或体验，不要求每章反转。章尾可以承接行动、会面、选择、探索与陪伴；完结章允许完整结束。hooks_realized 只报告实际实现了什么，缺少悬崖钩不是谎报 true 的理由。
